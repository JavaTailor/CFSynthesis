 ...
 * @test 1.3 07/03/29
 * @bug 4634892
 * @summary  Ensure that client requesting privacy via RC4 cipher
 * causes resulting channel to be encrypted using RC4.
 */
...
public class PrivacyRc4 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        clntProps.put("com.sun.security.sasl.digest.cipher", "rc4-56");
