 ...
 * @test
 * @bug 4634892
 * @summary Ensure that supplying a list of realms in the
 * "com.sun.security.sasl.digest.realm" property to the SASL server works.
 */

/*
 * Server sends list of specified realms to client. Client selects one.
