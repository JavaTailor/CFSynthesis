...
class MethodCallsReflection {
    ...
    static void staticCaller3(MethodCallsReflection mc) throws Exception {
         ...
         */
        java.lang.reflect.Method m = MethodCallsReflection.class.getDeclaredMethod("staticExceptionCallee", new Class[0]);
    ...
    void instanceCaller3() throws Exception {
         ...
         * since Method.invoke is a native method.
         */
        java.lang.reflect.Method m = getClass().getDeclaredMethod("instanceExceptionCallee", new Class[0]);
