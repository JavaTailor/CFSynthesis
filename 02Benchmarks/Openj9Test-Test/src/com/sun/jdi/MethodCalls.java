...
class MethodCalls {
    ...
    static void staticCaller(MethodCalls mc) throws Exception {
         ...
         */
        java.lang.reflect.Method m = MethodCalls.class.getDeclaredMethod("staticCallee", new Class[0]);
    ...
    void instanceCaller() throws Exception {
         ...
         * since Method.invoke is a native method.
         */
        java.lang.reflect.Method m = getClass().getDeclaredMethod("instanceCallee", new Class[0]);
