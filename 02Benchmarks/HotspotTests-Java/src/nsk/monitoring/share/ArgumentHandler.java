...
public class ArgumentHandler extends ArgumentParser {
    ...
    public String getTestMode() {
        return vmoptions.getProperty(TEST_MODE, DIRECTLY_MODE);
    }
    ...
    public String getServerType() {
        return vmoptions.getProperty(SERVER_TYPE, DEFAULT_TYPE);
    }
    ...
    public int getLoadersCount() {
        String val = vmoptions.getProperty(LOADERS_COUNT, "100");
        int number;
        try {
    ...
    public boolean singleClassloaderClass() {
        return vmoptions.getProperty(SINGLE_CLASSLOADER_CLASS) != null;
    }
    ...
    public int getLoadableClassesCount() {
        String val = vmoptions.getProperty(LOADABLE_CLASSES_COUNT, "1");
        int number;
        try {
            number = Integer.parseInt(val);
        } catch (NumberFormatException e) {
    ...
    public String getInvocationType() {
        return vmoptions.getProperty(INVOCATION_TYPE, JAVA_TYPE);
    }
    ...
    public String getTestedMemory() {
        return vmoptions.getProperty(MEMORY_TYPE, MT_HEAP);
    }
    ...
    public int getTimeout() {
        String value = vmoptions.getProperty(TIMEOUT, "30");
    ...
    public int getThreadDepth() {
        String value = vmoptions.getProperty(THREAD_DEPTH, "1");
    ...
    public int getThreadCount() {
        String value = vmoptions.getProperty(THREAD_COUNT, "1");
    ...
    public String getMonitoring() {
        return vmoptions.getProperty(MONITORING, MON_NOTIF);
    }
    ...
    public String getThreshold() {
        return vmoptions.getProperty(THRESHOLD, TH_USAGE);
    }
    ...
    public String getScenarioType() {
            return vmoptions.getProperty(SCENARIO_TYPE, "running");
    }

    public int getIterations() {
            return Integer.parseInt(vmoptions.getProperty(ITERATIONS, "3"));
    }
