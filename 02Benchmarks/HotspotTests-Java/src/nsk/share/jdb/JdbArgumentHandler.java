...
public class JdbArgumentHandler extends nsk.share.jdi.ArgumentHandler {
    ...
    public String getWorkDir() {
        return vmoptions.getProperty("workdir", "");
    }
    ...
    public String getJdbExecPath() {
        return vmoptions.getProperty("jdb");
    }
    ...
    public String getJdbOptions() {
        return vmoptions.getProperty("jdb.option", "");
    }
    ...
    public String getDebuggeeOptions() {
        ...
        String value = vmoptions.getProperty("debugee.vmkeys", "").trim();
    ...
    public String getJavaOptions() {
        String value = vmoptions.getProperty("java.options", "").trim();
        if (value.length() > 1 && value.startsWith("\"") && value.endsWith("\"")) {
            value = value.substring(1, value.length() - 1).trim();
        }
        return value;
