...
public class ArgumentHandler extends ArgumentParser {
    ...
    public int getIterations() {
        String value = vmoptions.getProperty(ITERATIONS, "1");
    ...
    public int getAggregationDepth() {
        String value = vmoptions.getProperty(AGGREGATION_DEPTH, "0");
    ...
    public int getGCTimeout() {
        String value = vmoptions.getProperty(GC_TIMEOUT);
    ...
    public String getLargeClassesPath() {
        return vmoptions.getProperty(LARGE_CLASSES_PATH);
    }
    ...
    public int getThreads(int defaultValue) {
        String value = vmoptions.getProperty(THREADS);
    ...
    public boolean isSingleMemoryEater() {
        String value = vmoptions.getProperty(MEM_EATER);
    ...
    public boolean isOverFieldsLimitation() {
        String value = vmoptions.getProperty(FIELDS_LIMITATION);
