...
//        parseArguments();
    ...
    public String getTransportType() {
        return vmoptions.getProperty("transport", "default");
    }
    ...
    public String getConnectorType() {
        return vmoptions.getProperty("connector", "default");
    }
    ...
    public String getTraceModeString() {
        return vmoptions.getProperty("jdi.trace", "none");
    }
    ...
    public int getConnectionDelay() {
        String value = vmoptions.getProperty("connectionDelay", "4000");
        try {
