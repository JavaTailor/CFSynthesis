...
public class DebugeeArgumentHandler extends ArgumentParser {
    ...
    public String getTestHost() {
        return vmoptions.getProperty("test.host", "localhost");
    }
    ...
    public String getDebugeeHost() {
        return vmoptions.getProperty("debugee.host", getTestHost());
    }
    ...
    synchronized public String getTransportPort() {
        String port = vmoptions.getProperty("transport.port");
        if (port == null) {
            if (!transportPortInited) {
                ...
                vmoptions.setProperty("transport.port", port);
    ...
    public String getTransportSharedName() {
        return vmoptions.getProperty("transport.shname", defaultTransportSharedName);
    }
    ...
    public boolean isTransportAddressDynamic() {
        String value = vmoptions.getProperty("transport.address", null);
    ...
    public String getDebugeeSuspendMode() {
        return vmoptions.getProperty("debugee.suspend", "default");
    }
    ...
    synchronized public String getPipePort() {
        String port = vmoptions.getProperty("pipe.port");
        if (port == null) {
            if (!pipePortInited) {
                port = findFreePort();
                if (port == null) {
                ...
                pipePortInited = true;
                vmoptions.setProperty("pipe.port", port);
            }
        }
        return port;
    }
    ...
    public String getLaunchMode() {
        return vmoptions.getProperty("debugee.launch", "local");
    }
    ...
    public String getLaunchOptions() {
        String result = vmoptions.getProperty("debugee.vmkeys", "").trim();
    ...
    public String getLaunchExecName() {
        return vmoptions.getProperty("debugee.vmkind", "java");
    }
    ...
    public String getDebugeeJavaHome() {
        ...
        return vmoptions.getProperty("debugee.vmhome", java_home);
    }
    ...
    public boolean isDefaultLaunchExecName() {
        String vmkind = vmoptions.getProperty("debugee.vmkind", null);
        return (vmkind == null);
    }
    ...
    public boolean isDefaultDebugeeJavaHome() {
        String java_home = vmoptions.getProperty("debugee.vmhome", null);
    ...
    public String getBindPort() {
        String port = vmoptions.getProperty("bind.port");
        if (port == null) {
            if (!bindPortInited) {
                port = findFreePort();
                if (port == null) {
                ...
                vmoptions.setProperty("bind.port", port);
                bindPortInited = true;
            }
        }
        return port;
    ...
    public String getJVMDIStrictMode() {
        return vmoptions.getProperty("jvmdi.strict", "default");
    }
    ...
    public String getConnectorType() {
        return vmoptions.getProperty("connector", "listening");
    }
    ...
    public boolean isDefaultConnector() {
        return vmoptions.getProperty("connector") == null;
    }
    ...
    public String getTransportType() {
        return vmoptions.getProperty("transport", "socket");
    }
    ...
    public boolean isDefaultTransport() {
        return vmoptions.getProperty("transport") == null;
    }
