 ...
 * @run junit/othervm -XX:+UnlockExperimentalVMOptions -XX:+EnableJVMCI -Djvmci.Compiler=null compiler.jvmci.jdk.vm.ci.code.test.VirtualObjectDebugInfoTest
 */

package compiler.jvmci.jdk.vm.ci.code.test;
