    ...
    public static Object[][] readArrayLengthDataProvider() {
        ...
        for (int i : new int[]{0, 1, 42}) {
            createListOfDummyArrays(i).stream().forEach((array) -> {
                cfgSet.add(new Object[]{TestHelper.CONSTANT_REFLECTION_PROVIDER.forObject(array), i});
            });
        }
        cfgSet.add(new Object[]{null, null});
        cfgSet.add(new Object[]{JavaConstant.NULL_POINTER, null});
        cfgSet.add(new Object[]{TestHelper.CONSTANT_REFLECTION_PROVIDER.forObject(TestHelper.DUMMY_CLASS_INSTANCE.intField), null});
        cfgSet.add(new Object[]{JavaConstant.forInt(TestHelper.DUMMY_CLASS_INSTANCE.intField), null});
