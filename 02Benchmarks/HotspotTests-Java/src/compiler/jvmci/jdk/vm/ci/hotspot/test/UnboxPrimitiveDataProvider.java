...
public class UnboxPrimitiveDataProvider {
    ...
    public static Object[][] unboxPrimitiveDataProvider() {
        ...
        // Testing boolean
        cfgSet.add(new Object[]{TestHelper.CONSTANT_REFLECTION_PROVIDER.forObject(
                        true), JavaConstant.forBoolean(true)});
        cfgSet.add(new Object[]{JavaConstant.forBoolean(true), null});
        cfgSet.add(new Object[]{TestHelper.CONSTANT_REFLECTION_PROVIDER.forObject(false),
        ...
        for (byte number : new byte[]{-128, 0, 1, 127}) {
            ...
            cfgSet.add(new Object[]{TestHelper.CONSTANT_REFLECTION_PROVIDER.forObject(Byte.valueOf(number)),
                            JavaConstant.forByte(number)});
            cfgSet.add(new Object[]{TestHelper.CONSTANT_REFLECTION_PROVIDER.forObject(Short.valueOf(number)),
                            JavaConstant.forShort(number)});
            cfgSet.add(new Object[]{TestHelper.CONSTANT_REFLECTION_PROVIDER.forObject(Integer.valueOf(number)),
                            JavaConstant.forInt(number)});
            cfgSet.add(new Object[]{TestHelper.CONSTANT_REFLECTION_PROVIDER.forObject(Long.valueOf(number)),
        ...
        cfgSet.add(new Object[]{TestHelper.CONSTANT_REFLECTION_PROVIDER.forObject(Short.MAX_VALUE),
                        JavaConstant.forShort(Short.MAX_VALUE)});
        cfgSet.add(new Object[]{TestHelper.CONSTANT_REFLECTION_PROVIDER.forObject(Integer.MAX_VALUE),
                        JavaConstant.forInt(Integer.MAX_VALUE)});
        cfgSet.add(new Object[]{TestHelper.CONSTANT_REFLECTION_PROVIDER.forObject(Long.MAX_VALUE),
                        JavaConstant.forLong(Long.MAX_VALUE)});
        cfgSet.add(new Object[]{TestHelper.CONSTANT_REFLECTION_PROVIDER.forObject(Character.MAX_VALUE),
                        JavaConstant.forChar(Character.MAX_VALUE)});
        cfgSet.add(new Object[]{TestHelper.CONSTANT_REFLECTION_PROVIDER.forObject(Float.MAX_VALUE),
                        JavaConstant.forFloat(Float.MAX_VALUE)});
        cfgSet.add(new Object[]{TestHelper.CONSTANT_REFLECTION_PROVIDER.forObject(Double.MAX_VALUE),
                        JavaConstant.forDouble(Double.MAX_VALUE)});
        // Non-primitives testing
        cfgSet.add(new Object[]{TestHelper.CONSTANT_REFLECTION_PROVIDER.forObject(
                        TestHelper.DUMMY_CLASS_INSTANCE.objectField), null});
        cfgSet.add(new Object[]{TestHelper.CONSTANT_REFLECTION_PROVIDER.forObject(
                        TestHelper.DUMMY_CLASS_INSTANCE.booleanArrayWithValues),
                        null});
        // Null testing
