...
public class HotSpotConstantReflectionProviderTest {
    ...
    public void testForString(String string, String expected) {
        JavaConstant jConst = TestHelper.CONSTANT_REFLECTION_PROVIDER.forString(string);
        Assert.assertNotNull(jConst,
    ...
    public void testConstantEquals(Constant const1, Constant const2, Boolean expected) {
        Assert.assertEquals(TestHelper.CONSTANT_REFLECTION_PROVIDER.constantEquals(const1, const2), expected,
                        "Unexpected result:");
    }
    ...
    public void testReadArrayLength(JavaConstant array, Integer expected) {
        Assert.assertEquals(TestHelper.CONSTANT_REFLECTION_PROVIDER.readArrayLength(array), expected,
                        "Unexpected result:");
    }
    ...
    public void testReadArrayElement(JavaConstant array, int index, Object expected) {
        Assert.assertEquals(TestHelper.CONSTANT_REFLECTION_PROVIDER.readArrayElement(array, index), expected,
                        "Unexpected result:");
    }
    ...
    public void testReadFieldValue(ResolvedJavaField field, JavaConstant receiver, JavaConstant expected) {
        JavaConstant actual = TestHelper.CONSTANT_REFLECTION_PROVIDER.readFieldValue(field, receiver);
    ...
    public void testNegativeReadFieldValue(ResolvedJavaField field, JavaConstant receiver) {
        TestHelper.CONSTANT_REFLECTION_PROVIDER.readFieldValue(field, receiver);
    }
    ...
    public void testAsJavaType(JavaConstant constant, String expected) {
        ResolvedJavaType actual = TestHelper.CONSTANT_REFLECTION_PROVIDER.asJavaType(constant);
    ...
    public void testBoxPrimitive(JavaConstant constant, JavaConstant expected) {
        JavaConstant actual = TestHelper.CONSTANT_REFLECTION_PROVIDER.boxPrimitive(constant);
    ...
    public void testUnboxPrimitive(JavaConstant constant, JavaConstant expected) {
        JavaConstant actual = TestHelper.CONSTANT_REFLECTION_PROVIDER.unboxPrimitive(constant);
        Assert.assertEquals(actual, expected, "Unexpected result:");
    }

    @Test
    public void testGetMemoryAccessProvider() {
        MemoryAccessProvider actual = TestHelper.CONSTANT_REFLECTION_PROVIDER.getMemoryAccessProvider();
    ...
    public void testGetMethodHandleAccess() {
        MethodHandleAccessProvider actual = TestHelper.CONSTANT_REFLECTION_PROVIDER.getMethodHandleAccess();
